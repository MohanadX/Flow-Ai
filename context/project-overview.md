...
Flow AI is a real-time collaborative system design workspace. Users describe a system in plain English, an AI agent maps that system onto a shared canvas, collaborators refine the architecture, and the app generates a technical specification from the resulting graph.
...
6. AI generates nodes and edges in the shared canvas.
   ...
   User triggers spec generation.
   App persists the generated Markdown spec.
   User reviews or downloads the spec.
